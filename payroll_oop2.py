class Employee_Info:
    ...
    def desiplay_data(self):
        ...
        print("Cut-Pff Date:", self.salary_cut_off)
...
class Employee_Salary:
    ...
    def get_overtime_pay(self, emp_rate_per_hour, hour_overime):
        self.overtime_pay = hour_overime * emp_rate_per_hour
