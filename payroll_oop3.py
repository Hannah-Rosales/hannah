...
obj1 = payroll_oop2.Employee_Info()
company = input("Enter company name: ")
department = input("Enter employee department: ")
employee_name = input("Enter employee name: ")
employee_code = input("Enter employee's number or code: ")
salary_cutoff = input("Enter salary cut off: ")
emp_data = obj1.get_emp_data(company, department, employee_name, employee_code, salary_cutoff)
