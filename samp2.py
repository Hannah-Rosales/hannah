...
def main():
    student = Activity4_Class.Student_Info()
    name = input("Enter student name: ")
    course = input("Enter course: ")
    student_number = input("Enter student number: ")
    academic_year = input("Enter academic year: ")
    current_date = input("Enter current date (YYYY-MM-DD): ")
    student_data = student.get_student_data(name, course, student_number, academic_year, current_date)

    academic_details = Activity4_Class.Academic_Details
